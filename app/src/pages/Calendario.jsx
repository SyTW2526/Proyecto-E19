...
function Calendario({ menu, activeSubsection }) {
    ...
    <div className="bg-white rounded-lg p-4 sm:p-6 lg:p-8 shadow-sm">
      <div className="flex flex-col items-center justify-center min-h-[300px] sm:min-h-[400px] lg:min-h-[500px]">
        <div className="text-center">
          <div className="mb-4">
            <Icon name={item.icon || 'calendar'} className="w-12 h-12 sm:w-14 sm:h-14 lg:w-16 lg:h-16 mx-auto text-gray-400" />
          </div>
          <h2 className="text-lg sm:text-xl lg:text-2xl font-bold text-gray-900 mb-2">
            {item.label || 'Calendario'}
          </h2>
          <p className="text-sm sm:text-base text-gray-600 max-w-md px-4">
            Parte de Jose Visualiza todos tus eventos y reservas en un calendario centralizado.
          </p>
